...
const FOREST: RGB = [14, 74, 54];     // #0E4A36
const LABELGREEN: RGB = [11, 107, 79]; // #0B6B4F
const MINT: RGB = [24, 195, 154];     // #18C39A
const GOLD: RGB = [194, 135, 27];     // #C2871B
const EMBER: RGB = [217, 104, 46];    // #D9682E
const CHIPBG: RGB = [227, 247, 240];  // #E3F7F0
const CALLBORDER: RGB = [213, 240, 230]; // #D5F0E6
