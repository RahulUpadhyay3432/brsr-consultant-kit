...
// numbers, citations, deadlines or product features. Best-effort, never throws, // returns { answer: null } on any failure so HelpWidget falls back to keyword search.
